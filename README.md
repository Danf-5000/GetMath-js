#GetMath-js
Идеи для обновлений пока что нет
В будущем может будут еще обновление
До идеи!
...
RectangleP(a, b) - периметр прямоугольника

TriangleP(a, b , c) - периметр треугольника
